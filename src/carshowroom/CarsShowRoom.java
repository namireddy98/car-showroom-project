        ...
        Scanner carz = new Scanner(System.in);
            ...
            for(int x = 0 ; x < numOfRent; x++){
                ...
                System.out.println("Enter Information Of Customer of Car "+ (x+1));
                             ...
                             System.out.println("Enter 1 For Available Car "
                                     + "\n And Enter 0 for Not Available Car");
                             
                             int avail = ic.nextInt();
                             ...
                             cars.calculateAmount(Days, perDay);
                ...
                System.out.println("Total Amount For Car is: "+  cars.calculateAmount(Days, perDay)); 
    ...
    public static void BoughtCar(){
        ...
        System.out.println("Enter How Many Cars Purchased: ");
            ...
            for(int x = 0 ; x < numOfPurchased ; x++){
                ...
                System.out.println("Total Amount For Car is: "+purchased.calculateAmount(price,0)); 
    ...
    public static void SoldCar(){
        ...
        Scanner carz = new Scanner(System.in);
            ...
            for(int i = 0 ; i < numOfSold ; i++){
               ...
               cars.calculateAmount(price,commission);
        
               cars.Saved();
               
               Cars sold = new Sold_Cars( price , commission ,n,number,model,city,color, P1);
 
                System.out.println("Total Amount For Car is: "+sold.calculateAmount(price,commission)); 
